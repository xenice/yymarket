    ...
    <div class="yy-group">
        <div class="breadcrumb">
        	<div class="container">
        	    ...
        	    <a class="breadcrumb-item" href="<?php echo get_term_link($terms[0]->term_id, 'product_cat')?>"><?php echo $terms[0]->name ?></a>
        	    <?php else:?>
              ...
              <div class="col-md-4 right">
                  <div class="md-down-none">
                      <?php 
                        ...
                        include __DIR__ . '/download-part.php';
                        ?>
                  </div>
                    		...
                    		<li>
                                ...
                                <div class="meta">
                                    ...
                                    <div class="bottom-data">
                                	    ...
                                	    <div class="price"><?php echo yy_get_price( $cur_post->ID)?:'';?></div>
                                	</div>
                                </div>
                            </li>
            			<?php endforeach; ?>
