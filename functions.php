...
require_once get_template_directory() . '/vessel/vessel.php';

require_once get_template_directory() . '/includes/class-wp-optimizer.php';

require_once get_template_directory() . '/includes/class-tgmpa.php';

require_once get_template_directory() . '/woocommerce/functions.php';

require_once get_template_directory() . '/woocommerce/class-product-custom-fields.php';

require_once get_template_directory() . '/woocommerce/class-checkout-cleaner.php';

require_once get_template_directory() . '/woocommerce/class-my-account-cleaner.php';


new WP_Optimizer();
new YYMarket_TGMPA;
new YY_Product_Custom_Fields;
new YY_Checkout_Cleaner;
new YY_My_Account_Cleaner;
...
function yy_login() {
	...
	if ( isset( $user->ID ) ) {
		...
		<?php if(function_exists('wc_get_account_endpoint_url')):?>
		    <a class="dropdown-item" href="<?php echo esc_attr( wc_get_account_endpoint_url( 'dashboard' )); ?>"><?php echo $user->display_name; ?></a>
            <a class="dropdown-item" href="<?php echo esc_attr( wc_get_account_endpoint_url( 'orders' )); ?>"><?php esc_html_e( 'Orders', 'onenice' ); ?></a>
            <a class="dropdown-item" href="<?php echo esc_attr( wc_get_account_endpoint_url( 'downloads' )); ?>"><?php esc_html_e( 'Downloads', 'onenice' ); ?></a>
            <a class="dropdown-item" href="<?php echo esc_attr( wc_get_account_endpoint_url( 'customer-logout' )); ?>"><?php esc_html_e( 'Logout', 'onenice' ); ?></a>
	    ...
	    <?php if(function_exists('wc_get_account_endpoint_url')):?>
	        <div class="dropdown">
		    <a class="yy-user" href="<?php echo esc_attr( wc_get_account_endpoint_url( 'dashboard' )); ?>"><i class="fa fa-user" aria-hidden="true"></i></a>
            </div>
		<?php endif;?>
	    <?php
	}
